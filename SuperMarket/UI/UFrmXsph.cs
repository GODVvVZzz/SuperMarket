...
namespace SuperMarket.UI
{
    public partial class UFrmXsph : UserControl
    {
        ...
        private void UFrmXsph_Load(object sender, EventArgs e)
        {
            ...
            myconn.Open();
            string sql = "select EID from Employee where EPID=6";
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            MySqlConnection myconn = BaseClass.DBConn.MyConn();
            myconn.Open();
            string sql = "select OGID as 商品编号, OGName as 商品名称, OGCID as 类别, OGAmount as 数量, OGPrice as 单价, OGUnit as 单位, OGSum as 总价 from sellOrder where OEID='" + cmbox_EID.Text + "'";
