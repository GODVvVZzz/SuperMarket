...
namespace SuperMarket.UI
{
    public partial class FrmGoodsSupplier : Form
    {
        ...
        public void BindData()
        {
            ...
            myconn.Open();
            string sql = "select GSName as 供应商,GSPName as 负责人, GSTel as 联系电话, GSAddress as 地址, GSNotes as 备注,GSID as GSID from GoodsSupplier order by GSID asc";
        ...
        #region 窗体加载事件
        private void FrmGoodsSupplier_Load(object sender, EventArgs e)
        {
            BindData();
        }
        #endregion
        ...
        private void btn_Del_Click(object sender, EventArgs e)
        {
            MySqlConnection myconn = BaseClass.DBConn.MyConn();
            myconn.Open();
            string sql = "delete from GoodsSupplier where GSID=@gsid";
