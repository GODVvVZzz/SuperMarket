...
namespace SuperMarket.UI
{
    public partial class UFrmLsjyjl : UserControl
    {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                ordernum = "";
                string allsql = "select OID as 订单编号, OGID as 商品编号, OGName as 商品名称, OGCID as 类别, OGAmount as 数量, OGPrice as 单价, OGUnit as 单位, OGSum as 总价, OPaymentMethod as 付款方式 from sellOrder order by OID desc";
            ...
            else
            {
                if (cmbox_OrderNum.SelectedItem != null)
                {
                    ...
                    string onsql = "select OID as 订单编号, OGID as 商品编号, OGName as 商品名称, OGCID as 类别, OGAmount as 数量, OGPrice as 单价, OGUnit as 单位, OGSum as 总价, OPaymentMethod as 付款方式 from sellOrder where OID='" + ordernum + "' order by OID desc";
